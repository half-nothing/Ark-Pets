    ...
    public static class Languages {
        public enum Language {
            ...
            public static Language of(String name) {
                return Language.valueOf(name.toUpperCase(Locale.ROOT));
            }

        }

        public static final Language[] supportLanguages = {Language.DEFAULT, Language.EN, Language.ZH_CN, Language.ZH_TW};
    }
}
