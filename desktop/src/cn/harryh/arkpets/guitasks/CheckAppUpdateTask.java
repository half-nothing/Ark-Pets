    ...
    protected void onSucceeded(boolean result) {
        ...
        try {
            ...
            if (queryVersionResult.getString("msg").equals("success")) {
                ...
                if (appVersion.lessThan(stableVersion)) {
                    ...
                    if (style != GuiTaskStyle.HIDDEN)
                        GuiPrefabs.Dialogs.createCommonDialog(parent,
                                GuiPrefabs.Icons.getIcon(GuiPrefabs.Icons.ICON_INFO_ALT, GuiPrefabs.COLOR_INFO),
                                "检查软件更新",
                                "检测到软件有新的版本！",
                ...
                if (style != GuiTaskStyle.HIDDEN)
                    GuiPrefabs.Dialogs.createCommonDialog(parent,
                            GuiPrefabs.Icons.getIcon(GuiPrefabs.Icons.ICON_DANGER, GuiPrefabs.COLOR_DANGER),
                            "检查软件更新",
                            "服务器返回了无效的消息。",
